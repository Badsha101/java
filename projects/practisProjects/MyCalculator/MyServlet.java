...
import jakarta.servlet.annotation.WebSevlet;
...
/**
    ...
    protected void doGet(HttpServletRequest request, htt HttpServletResponse response) throws ServletException, IOException{
    ...
    int randomJoke = jokes[randomIndex];
